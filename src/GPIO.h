 ...
 */
#define _GPIO_ENABLE_DEBOUNCE(PORT, pin)         ((PORT)->DBEN |= (GPIO_DBEN_ENABLE(pin) | GPIO_DBNCECON_ICLK_ON_Msk))
 ...
 */
#define _GPIO_SET_DEBOUNCE_TIME(clksrc, clksel)  (GPIO->DBNCECON |= (clksrc | clksel))
