...
uint8_t Flag_Incomming = 0;
uint8_t isCheckingBattery=0;
uint8_t Flag_Power_Down = 0;
uint8_t Flag_async_Power_Down = 0;

uint8_t BattKey = 0;
uint8_t HelpKey = 0;
uint8_t LongBattKey = 0;
uint8_t LongHelpKey = 0;
uint8_t Flag_LowBat = 0;
uint8_t Flag_ObtainGps = 0;
uint8_t	Flag_SimExist = 1;
uint8_t	Flag_MsgDebug = 0;
...
uint8_t SystemTime;
uint8_t Flag_GpsStart = 0;
uint8_t gPhoneNumOk = PHONE_NUM_BUSY;
uint8_t Flag_ModuleOn = 0;
...
int32_t main()
{
	...
	(*((volatile unsigned int *)(&((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P0_MFP))=0);
	(*((volatile unsigned int *)(&((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P1_MFP))=0);
	(*((volatile unsigned int *)(&((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P2_MFP))=0);
	(*((volatile unsigned int *)(&((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P3_MFP))=0);
	(*((volatile unsigned int *)(&((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P4_MFP))=0);
	...
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->PMD = ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->PMD & ~((0x3UL) << ((5)<<1))) | ((0x3UL) << ((5)<<1)));
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->PMD = ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->PMD & ~((0x3UL) << ((4)<<1))) | ((0x3UL) << ((4)<<1)));

	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )))->PMD = ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )))->PMD & ~((0x3UL) << ((4)<<1))) | ((0x1UL) << ((4)<<1)));
	ModemSleep(0);

	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->PMD = ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->PMD & ~((0x3UL) << ((4)<<1))) | ((0x1UL) << ((4)<<1)));
	
	LedDark();
	
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->PMD = ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->PMD & ~((0x3UL) << ((2)<<1))) | ((0x0UL) << ((2)<<1)));
			                      ...
			                      LockPower(0);
												...
												while (tmp_my<25){               
																										  ...
																										  if (counterPress>2){ 
																																					...
																																					delay_ms(2000);
																																					custermParam.param.lockState = 1;
																																					WriteToNv( &custermParam ); 
																																		      tmp_my=0;
																																					delay_ms(2000);
																																					LockPower(0);
...
#line 280 "main.c"
		...
		if(TimerWait == 0)
		{
			...
			case STATE_GSM_STEADY:	
				if( gPhoneNumOk==PHONE_NUM_READY || Flag_SimExist==0)
					EnterCall();
				else
					TimerWait = 40;
				break;
